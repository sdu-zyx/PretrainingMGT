...
class PMGTTrainerModel(BaseTrainerModel):
    ...
    # def predict_step(self, batch, batch_idx: int, dataloader_idx: Optional[int] = None) -> np.ndarray:
    #
    #     outputs = self.net(batch)
    #     node_emb = outputs[0][:, 0, :]
    #     print(node_emb.size())
